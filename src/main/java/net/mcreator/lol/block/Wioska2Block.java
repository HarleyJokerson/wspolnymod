...
package net.mcreator.lol.block;
...
import net.mcreator.lol.procedures.Wioskispaw2Procedure;
...
public class Wioska2Block extends LolModElements.ModElement {
	@ObjectHolder("lol:wioska_2")
	public static final Block block = null;
	public Wioska2Block(LolModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void animateTick(BlockState blockstate, World world, BlockPos pos, Random random) {
			...
			if (true)
				for (int l = 0; l < 4; ++l) {
					...
					world.addParticle(ParticleTypes.EFFECT, d0, d1, d2, 0, 0, 0);
				}
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				Wioskispaw2Procedure.executeProcedure($_dependencies);
			}
