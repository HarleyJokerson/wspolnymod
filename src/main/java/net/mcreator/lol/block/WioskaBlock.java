...
import net.mcreator.lol.procedures.WioskispawnProcedure;
...
public class WioskaBlock extends LolModElements.ModElement {
	@ObjectHolder("lol:wioska")
	public static final Block block = null;
	public WioskaBlock(LolModElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				WioskispawnProcedure.executeProcedure($_dependencies);
			}
