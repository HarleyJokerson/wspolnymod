...
import net.mcreator.lol.gui.KsiegaguiGuiWindow;
import net.mcreator.lol.gui.KsiegaguiGui;
...
public class KsiegaItem extends LolModElements.ModElement {
	@ObjectHolder("lol:ksiega")
	public static final Item block = null;
	public KsiegaItem(LolModElements instance) {
		super(instance, 34);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof KsiegaguiGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Ksiega");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new KsiegaguiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
