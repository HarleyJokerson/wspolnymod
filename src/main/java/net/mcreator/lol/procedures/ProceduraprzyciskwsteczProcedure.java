...
public class ProceduraprzyciskwsteczProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				LolMod.LOGGER.warn("Failed to load dependency entity for procedure Proceduraprzyciskwstecz!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		if ((((entity.getCapability(LolModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				.orElse(new LolModVariables.PlayerVariables())).numerstrony) == 2)) {
			{
